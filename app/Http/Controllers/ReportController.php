            ...
            return Datatables::of($contacts)
                ...
                ->editColumn('mobile', function ($row) {
                 ...
                 ->editColumn('quantity', function ($row) {
                   $quantity=DB::table('transactions')->where('contact_id',$row->id)->first();
                    $quantity1 = DB::table('transaction_sell_lines')->where('transaction_id',$quantity->id)->first();
                       return (float)$quantity1->quantity." Litre";
                       
                    
                })
                
                ->editColumn('alternate_number', function ($row) {
