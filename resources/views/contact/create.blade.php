  ...
  @endphp
    ...
    <div class="modal-body">
        <div class="row">            
            ...
            <div class="col-md-4">
                <div class="form-group">
                    {!! Form::label('contact_id', __('Vehicle Number') . ':') !!}
                    <div class="input-group">
                        <span class="input-group-addon">
            ...
            {{-- <div class="col-md-3 individual" style="display: none;">
                <div class="form-group">
                    ...
                    {!! Form::text('prefix', null, ['class' => 'form-control','required', 'placeholder' => __( 'business.prefix_placeholder' ) ]); !!}
                </div>
            </div> --}}
            {{-- <div class="col-md-3 individual" style="display: none;">
                <div class="form-group">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('Driver Name', __('Driver Name') . ':*') !!}
                    <div class="input-group">
                        <span class="input-group-addon">
                            <i class="fa fa-mobile"></i>
                        </span>
                        {!! Form::text('mobile', null, ['class' => 'form-control', 'required', 'placeholder' => __('Vehicle Number')]); !!}
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('Mobile Number', __('Mobile Number') . ':') !!}
                    <div class="input-group">
                        <span class="input-group-addon">
